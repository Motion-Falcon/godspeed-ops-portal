...
- Server: `SUPABASE_URL`, `SUPABASE_SERVICE_KEY`, `SUPABASE_ANON_KEY`, `SENDGRID_API_KEY`, `NO_REPLY_FROM_EMAIL`, `ASSIGNMENT_FROM_EMAIL`, `DEFAULT_FROM_EMAIL` (fallback), `PORTAL_NAME`, `CLIENT_URL`, `TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`, `TWILIO_VERIFY_SERVICE_SID`, `AI_VERIFICATION_URL`, `PORT`.
