...
${vars.end_date ? `End Date: ${vars.end_date}\n` : ""}${
    ...
    vars.number_of_positions
      ? `Number of Positions: ${vars.number_of_positions}\n`
      : ""
  }Our team will reach out to you soon with further details and next steps. 

Please review the attached Motion Falcon Employee Handbook 2024, which contains important information about our company policies, procedures, and expectations. This handbook will help you understand your rights and responsibilities as a Motion Falcon employee.
