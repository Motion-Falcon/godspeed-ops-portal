    ...
    <div className="legal-page-container">
      <div className="legal-page-content">
        ...
        <div className="legal-page-body">
          ...
          <h3>1.1. HD Group provides an online platform for:</h3>
          <ul>
          ...
          <p>
            <strong>4.2.</strong> Employers are solely responsible for final hiring decisions. HD Group is
          ...
          <p>
            ...
            software — remains the property of HD Group.
          </p>
          <p>
          ...
          <h3>12.1. You agree to indemnify and hold HD Group, its directors, employees, and
