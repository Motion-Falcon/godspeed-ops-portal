    ...
    <div className="page-container">
                    ...
                    <div className="column-filter">
                      ...
                      <div className="column-search">
                        <input
                          ...
                          onChange={(e) =>
                            setPaymentCycleFilter(e.target.value)
                          }
                          className="column-search-input"
                        />
                      </div>
                    ...
                    <div className="column-filter">
                      ...
                      <div className="column-search">
                        <div className="actions-info">
                          <span className="actions-help-text">View • Edit</span>
                        </div>
                      </div>
                    </div>
                  </th>
                ...
                {loading ? (
                  ...
                  clients.map((client) => (
                    <tr key={String(client.id)}>
                      ...
                      <td className="shortcode-cell">
                        {getFieldValue(client, "shortCode")}
                      </td>
                      <td className="listname-cell">
                        {getFieldValue(client, "listName")}
                      </td>
                      <td className="contact-cell">
                        {getFieldValue(client, "contactPersonName1")}
                      </td>
                      <td className="email-cell">
                        {getFieldValue(client, "emailAddress1")}
                      </td>
                      <td className="mobile-cell">
                        {getFieldValue(client, "mobile1")}
                      </td>
                      <td className="payment-method-cell">
                        {getFieldValue(client, "preferredPaymentMethod")}
                      </td>
                      <td className="payment-cycle-cell">
                        {getFieldValue(client, "payCycle")}
                      </td>
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to delete the client "${
          clientToDelete
            ? getFieldValue(clientToDelete, "companyName")
            : "Unknown"
      ...
      <ConfirmationModal
        ...
        title="Edit Client"
        message={`Are you sure you want to edit the client "${
          clientToEdit ? getFieldValue(clientToEdit, "companyName") : "Unknown"
        }"? You will be redirected to the client editor.`}
